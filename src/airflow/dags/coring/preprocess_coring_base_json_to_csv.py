...
def run_preprocess_json_to_csv():
    file_json = 'project_files/datalake/source/Pavement Evaluation Summaries and Data/rp-23-04_data_summary_may1.json'
    output_csv = 'project_files/datalake/source/Pavement Evaluation Summaries and Data/rp-23-04_data_summary_may1.csv'
    ...
    print(f"Completed JSON to CSV conversion for coring data from {file_json} to {output_csv}.")
...
with DAG(
    dag_id='preprocess_coring_base_json_to_csv',
